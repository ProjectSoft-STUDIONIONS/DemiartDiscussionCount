window['demiColorVer'] = '1.0.2';
(function(){
	'use strict';
	var u = "undefined" != typeof chrome ? chrome.extension.getBackgroundPage() : opera.extension.bgProcess;
	if (!localStorage.isInitialized) {
		localStorage['refresh_interval'] = 0.1666666666666667;
		localStorage['refresh_interval_text'] = '1 раз в 10 сек';
	...
	executeScripts = function(tabId){
		chrome.tabs.insertCSS(tabId, {"file":"css/codemirror.css"}, function(){
			chrome.tabs.executeScript(tabId,{"file":"js/prettify.js"},function(){
				chrome.tabs.executeScript(tabId,{"file":"js/lang-ml.js"},function(){
					chrome.tabs.executeScript(tabId,{"file":"js/lang-css.js"},function(){
						chrome.tabs.executeScript(tabId,{"file":"js/lang-sql.js"},function(){
							chrome.tabs.executeScript(tabId,{"file":"js/lang-as.js"},function(){
								chrome.tabs.executeScript(tabId,{"file":"js/codemirror.js"},function(){
									chrome.tabs.executeScript(tabId,{"file":"js/jquery.js"},function(){
										chrome.tabs.executeScript(tabId,{"file":"js/ddc-demicolor.js"});
									});
								});
							});
						});
	...
	*/
	contextMenuShow = function(){
		...
		ddcGoDemiColor = chrome.contextMenus.create({"title": "\u041f\u0435\u0440\u0435\u0439\u0442\u0438 \u043d\u0430 DemiColor", "contexts":[shcm], "parentId": ddcMenu, "onclick":itemMenuClick});
		ddcGoMorgoth = chrome.contextMenus.create({"title": "\u041f\u0435\u0440\u0435\u0439\u0442\u0438 \u043d\u0430 \u0418\u043c\u0438\u0434\u0436\u0445\u043e\u0441\u0442\u0438\u043d\u0433", "contexts":[shcm], "parentId": ddcMenu, "onclick":itemMenuClick});
		ddcGoDemiYouTube = chrome.contextMenus.create({"title": "\u041f\u0435\u0440\u0435\u0439\u0442\u0438 \u043d\u0430 \u041a\u0430\u043d\u0430\u043b YouTube", "contexts":[shcm], "parentId": ddcMenu, "onclick":itemMenuClick});
		...
		chrome.contextMenus.create({"title": "DemiColor \u0432 \u0444\u043e\u0440\u043c\u0435 \u043a\u043e\u043c\u0435\u043d\u0442\u0430\u0440\u0438\u0435\u0432", "type":"checkbox", "checked":(localStorage['demiColor']=='true') ? true : false, "contexts":[shcm], "parentId": ddcMenu, "onclick": onDemiColorChange});
	...
	*/
	...
	onDemiColorChange = function(info, tab){
		localStorage['demiColor'] = info.checked;
		/*
	   */
	},
		...
		xhr.onreadystatechange = function() {
			...
			*/
			...
			if (discussCount) {
				...
				chrome.browserAction.setTitle({'title':  "Demiart Discussion Count (DDC)"});
				chrome.contextMenus.update(ddcGoDemiItemMenu, {"title": "\u041f\u0435\u0440\u0435\u0439\u0442\u0438 \u043d\u0430 \u0444\u043e\u0440\u0443\u043c"});
			}
			dcc_c = discussCount;
			dcc_u = response.href;
	...
	*/
	...
	chrome.tabs.onUpdated.addListener(function(tabId, changeInfo, tab){
		...
		if(changeInfo.status=='loading' && localStorage['demiColor'] == 'true'){
			if(req.test(tab.url) && regusr.test(tab.url)==false && reqmes.test(tab.url)==false){
