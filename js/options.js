(function() {
	...
	document.addEventListener("DOMContentLoaded", function() {
		...
		if (b) {
			...
			for (p.checked = "true" == localStorage.demiColor ? !0 : !1;1 > a;) {
				a += .05, a = Number(a.toFixed(3)), e = document.createElement("option"), e.value = a, e.innerHTML = Math.round(100 * a) + "%", n.appendChild(e), e.value == d && (e.selected = "true");
			}
	...
	document.querySelector("#save").addEventListener("click", function() {
		...
		localStorage.demiColor = v.checked;
